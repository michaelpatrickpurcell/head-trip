...
% Setting Fonts
\usepackage{fontspec}
\renewfontfamily\sectfont[UprightFont={*-Black}]{Charter}%Clarendon-Bold}
%\renewfontfamily\sectfont[UprightFont={* 176 Bold}]{Libre Clarendon Wide}
...
\raggedright
\section{Overview}
Head Trip is a game for four players that is played with two decks of cards. During the game, each player will portray an \emph{aspect} of the personality of a teenage boy named Bobby. They are:
\begin{playerlist}
...
% 
%There are three types of challenges: \clubs\ (physical), \hearts~(social), and \spades\ (mental). Different aspects receive different rewards depending on the outcomes of the various types of challenges.
%
...
%When Bobby faces a challenge, the pilot will play a card to the \emph{tableau}. The outcome of the challenge will be determined by the rank of the card that they play. 


%The aspect who is controlling Bobby's actions is called the \emph{pilot}. To determine the outcome of a challenge, the pilot will add a card to the \emph{tableau}. The outcome of the challenge will be determined by the rank of that card. 
%
%Only one aspect, called the \emph{pilot}, will determine the outcome of each challenge.
%
%The outcome of each challenge will be determined by one of the aspects, called the \emph{pilot}. To do so, 
...
%	\phantom{\textbf{Fonts}:}\hspace{\itemindent}Card~Characters.
\end{description}
\vfill
