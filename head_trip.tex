...
%\setmainfont[Scale=3.125]{Libre Clarendon Wide}
%{\bfseries
%\begin{center}
...
\raggedright
\section{Overview}
Head Trip is a game for four players that is played with two decks of cards. During the game, each player will portray an \emph{aspect} of the personality of a teenage boy named Bobby.
\begin{playerlist}
